...
**Tests**: Contract and integration tests are REQUIRED for any story that changes
externally visible API behavior, workflow transitions, or machine-consumable error
semantics. Additional unit tests remain optional unless requested by the feature spec.
...
- [ ] T008 Configure structured error envelopes, correlation IDs, and logging infrastructure
- [ ] T009 Setup environment configuration management
- [ ] T010 Define contract validation and idempotency support shared by all stories
...
- [ ] T017 [US1] Add validation, machine-readable errors, and idempotency handling
- [ ] T018 [US1] Add correlation IDs and structured logging for user story 1 operations
...
- Contract and integration tests MUST be written and FAIL before implementation for
  any API-facing change
...
- Explicitly call out idempotency, error-code, and observability work when a story
  changes externally visible API behavior
