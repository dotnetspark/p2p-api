...
- Invoice approval GL posting now follows standard accounting by debiting expense and crediting `AP_CONTROL`, with specs, ADR notes, and interview docs updated to match [#35]
